...
function ProviderCabinet() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-gradient-to-br from-slate-50 via-white to-emerald-50/40 text-slate-950 lg:flex">
      ...
      {/* HEADER */}
      <header className="fixed left-0 right-0 top-0 z-20 flex min-h-[76px] items-center gap-3 border-b border-slate-200 bg-white/95 px-4 pl-16 backdrop-blur-xl sm:px-6 sm:pl-16 lg:left-[300px] lg:px-10 lg:pl-10">
        ...
        <div className="hidden h-11 w-full max-w-[400px] items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 px-4 text-slate-400 transition-colors duration-200 focus-within:border-emerald-500 focus-within:bg-white md:flex">
        ...
        <button
          type="button"
          className="relative grid h-11 w-11 place-items-center rounded-xl border border-slate-200 bg-white text-slate-700 shadow-sm transition-colors duration-200 hover:border-emerald-300 hover:text-emerald-700"
        ...
        <button
          type="button"
          className="hidden items-center gap-3 rounded-xl bg-white px-2.5 py-1.5 text-left shadow-sm ring-1 ring-slate-200 transition-colors duration-200 hover:ring-emerald-300 md:flex"
        >
      ...
      {/* HERO */}
      <section
        className="relative overflow-hidden rounded-2xl bg-emerald-700 px-6 py-8 text-white shadow-md sm:px-10 sm:py-10"
        style={{
      ...
      >
        ...
        <div className="absolute -bottom-24 right-24 h-64 w-64 rounded-full bg-emerald-300/15 blur-3xl" />
        ...
        <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-black text-emerald-800 shadow-sm transition-colors duration-200 hover:bg-emerald-50"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-emerald-900/40 px-4 py-2.5 text-sm font-black text-white ring-1 ring-white/30 transition-colors duration-200 hover:bg-emerald-900/60"
            >
      ...
      <section className="mt-6 grid gap-5 xl:grid-cols-[1fr_1.4fr]">
        <article className="group flex min-h-[170px] items-center gap-6 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100 transition-shadow duration-200 hover:shadow-md">
          <div className="relative grid h-24 w-24 shrink-0 place-items-center rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50">
            <span className="grid h-16 w-16 place-items-center rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-md">
          ...
          <div className="min-w-0 flex-1">
            ...
            <h3 className="mt-1 text-xl font-black">
              {activeBusiness?.name || "Xizmat qo'shilmagan"}
            </h3>
            <div
          ...
          <HiArrowRight className="hidden h-6 w-6 text-slate-300 transition-transform duration-200 group-hover:translate-x-1 group-hover:text-emerald-600 sm:block" />
        </article>
        ...
        <article className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
          <div className="mb-5 flex items-center justify-between gap-3">
            ...
            <button
              type="button"
              className="inline-flex h-9 items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 text-xs font-black text-slate-600 transition-colors duration-200 hover:border-emerald-300 hover:text-emerald-700"
            >
              Bu hafta
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {stats.map((item) => {
              ...
              return (
                <div
                  key={item.label}
                  className="rounded-xl bg-slate-50 p-4 transition-colors duration-200 hover:bg-white"
                >
      ...
      <section className="mt-6 grid gap-5 xl:grid-cols-[1fr_1.4fr]">
        <button
          type="button"
          onClick={() => navigate('/provider/services?new=1')}
          className="group relative flex min-h-[130px] items-center justify-between overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-600 to-teal-700 px-7 text-left text-white shadow-md transition-colors duration-200 hover:from-emerald-500 hover:to-teal-600"
        >
          <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-white/10" />
          <span className="relative flex items-center gap-5">
            <span className="grid h-14 w-14 place-items-center rounded-2xl bg-white/20 transition-colors duration-200 group-hover:bg-white group-hover:text-emerald-700">
          ...
          <HiArrowRight className="relative h-7 w-7 transition-transform duration-200 group-hover:translate-x-1" />
        </button>
            ...
            {actions.map((item) => {
              ...
              return (
                <button
                  ...
                  className="group flex min-h-[90px] flex-col items-center justify-center gap-2 rounded-xl bg-slate-50 text-sm font-bold text-slate-600 transition-colors duration-200 hover:bg-white"
                >
                  <span
                    className={`grid h-10 w-10 place-items-center rounded-xl transition-colors duration-200 ${actionColorClasses[item.color]}`}
                  >
                    <Icon className="h-5 w-5" />
                  </span>
                  {item.label}
        ...
        <article className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
          <div className="mb-5 flex items-center justify-between gap-3">
            ...
            <button
              type="button"
              onClick={() => navigate('/provider/statistics')}
              className="inline-flex items-center gap-1 text-sm font-black text-emerald-700 transition-colors duration-200 hover:text-emerald-800"
            >
              To'liq ko'rish
